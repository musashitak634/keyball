...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_universal(
    RGB_TOG  , AML_TO   , AML_I50  , AML_D50  , _______  , _______  ,                                        RGB_M_P  , RGB_M_B  , RGB_M_R  , RGB_M_SW , RGB_M
_SW, _______  , _______  ,
    RGB_MOD  , RGB_HUI  , RGB_SAI  , RGB_VAI  , RGB_SPI  , _______  ,                                        RGB_HUD  , RGB_SAD  , RGB_VAD  , RGB_SPD  , _______  , _______  ,
    RESET    , RGB_HUI  , RGB_SAI  , RGB_VAI  , RGB_SPI  , _______  ,                                        RGB_HUD  , RGB_SAD  , RGB_VAD  , RGB_SPD  , _______  , _______  ,
                  _______  , _______ , _______  ,         _______  , _______  ,                   _______  , _______  , _______       , _______  , _______
  ),
};
